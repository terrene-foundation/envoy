...
| [session-runtime.md](session-runtime.md)                         | Store-backed `SessionRouter` + two durable projections                    | WS-6 deep-dive Q1 Option A     | Persistent-session substrate; pending-grant sub-store + SessionObservedState region (code-first S4s) |
